...
protected $listeners = ['render' => 'render'];
    ...
    public function render()
    {
        ...
        return view('livewire.devoluciones.vistaprincipal', [
            'devoluciones' => Devolucion::select( 'devolucions.id','devolucions.Estado_Devolucion','prestamos.Tipo_Elemento' ,'Bibliotecario_Re', 'devolucions.created_at','Novedades','Estado_Devolucion','Cantidad_Devuelta', 'users.name' ,'prestamos.Fecha_prestamo','libros.Nombre' ,'elementos.nombre')
...
->orWhere('prestamos.Fecha_prestamo', 'LIKE', $keyWord)
